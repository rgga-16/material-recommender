...
const proxyPaths = [
	...
	'/init_query', '/query', '/translate', '/suggest', '/feedback_scene',
	'/get_texture_prompts', '/get_materials', '/material_properties',
	'/design_brief', '/app_config', '/brainstorm_material_queries',
