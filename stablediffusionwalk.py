...
def diffuse(
    ...
    for i, t in enumerate(pipe.scheduler.timesteps):
        ...
        if isinstance(pipe.scheduler, LMSDiscreteScheduler):
            ...
            '''
            cond_latents = pipe.scheduler.step(noise_pred, i, cond_latents, **extra_step_kwargs)
...
def run(
        ...
        prompt = "red leather texture map, 4k", # prompt to dream about
        gpu = 0, # id of the gpu to run on
        name = 'red leather_walk', # name of this project, for the output directory
        rootdir = './out',
        num_steps = 50, # number of steps between each pair of sampled points
        ...
        quality = 100, # for jpeg compression of the output images
        eta = 0.0,
        width = 256,
        height = 256,
